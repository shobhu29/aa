...
public class CustomerController {
	...
	public Customer createAccount(@PathVariable String name, @PathVariable String mobileNo,
			@PathVariable BigDecimal balance) throws DuplicateMobileNumberException {
	...
	public List<Customer> fundTransfer(@PathVariable String sourceMobileNo, @PathVariable String targetMobileNo,
